...
# Examples:
#   Single: "degrando/csgo-egg"
#   Multiple: "degrando/csgo-egg ghcr.io/degrando/csgo-egg"
#   With commas: "degrando/csgo-egg,ghcr.io/degrando/csgo-egg"
...
log_ok()      { echo -e "вњ“ ${BOLD}${GREEN}DONE${RESET}  $*" >&2; }
log_warn()    { echo -e "вљ  ${BOLD}${YELLOW}WARN${RESET}  $*" >&2; }
log_error()   { echo -e "вњ— ${BOLD}${RED}ERROR${RESET} $*" >&2; }
section()     { echo -e "\n${BOLD}${MAGENTA}==>${RESET} ${BOLD}$*${RESET}\n" >&2; }
headline()    {
    local title="$1"
    echo -e "${BOLD}${BLUE}в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ${RESET}" >&2
    echo -e "${BOLD}${BLUE} ${title}${RESET}" >&2
    echo -e "${BOLD}${BLUE}в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ${RESET}\n" >&2
}
        ...
        if grep -q "state is 0x" "$log_file" 2>/dev/null; then
            ...
            case "$error_code" in
                0x202)
                    ...
                    log_info "вЂў CSGO requires ~25GB for initial installation"
                    log_info "вЂў After VPK sync, servers only use ~3-8GB each"
                    log_info "вЂў VPK files (~52GB) shared from centralized location"
                    echo "" >&2
                ...
                *)
                    ...
                    log_info "вЂў Check SteamCMD documentation for details"
                    log_info "вЂў Review full output above for more context"
                    ;;
            esac
        fi
...
update_csgo() {
    ...
    if [ "$version_before" = "$version_after" ]; then
        ...
        if [ "$version_before" = "unknown" ]; then
            ...
            log_ok "CSGO updated successfully: $version_before в†’ ${BOLD}$version_after${RESET}"
        fi
    fi
...
apply_update() {
    ...
    log_info "в•”в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•—"
    log_info "в•‘              APPLYING SCRIPT UPDATE                         в•‘"
    log_info "в• в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•Ј"
    log_info "в•‘ Backup directory: ${UPDATE_BACKUP_DIR##*/}"
    log_info "в•‘ Restarting with updated version..."
    log_info "в•љв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ќ"
...
check_and_apply_updates() {
    ...
    # Update available
    log_info "New version available: ${BOLD}$current_version${RESET} в†’ ${BOLD}$new_version${RESET}"
...
main() {
    ...
    headline "Degrando CSGO Centralized Update"
